...
export default function ApplicationFilters({ 
  ...
  return (
    <motion.div
      ...
      className="fixed left-0 top-0 h-full w-80 glass-panel border-r border-white/30 shadow-xl z-40 overflow-y-auto"
    >
      <div className="p-6">
        ...
        <div className="space-y-4">
          {filterOptions.map((option) => (
            <label
              key={option.id}
              className="flex items-center justify-between cursor-pointer hover:bg-white/50 p-3 rounded-lg transition-colors group"
            >
