...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 relative">
      {/* Left Side - Completely Independent */}
      <div className="absolute left-0 top-0 w-1/2 h-full flex items-center justify-center p-8 pl-16">
        <motion.div 
      ...
      {/* Right Side - Completely Independent */}
      <div className="absolute right-0 top-0 w-1/2 h-full flex items-center justify-center p-8 pr-16">
        <motion.div 
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
